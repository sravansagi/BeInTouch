 ...
 */
public class ContactsEntryCursorAdapterRecycler extends CursorRecyclerViewAdapter<ContactsEntryCursorAdapterRecycler.ViewHolder> {
    ...
    public ContactsEntryCursorAdapterRecycler(Cursor cursor, String comparisonColumn, OnItemClickListener listener, Context context){
